...
RSpec.describe('routes for Movements', type: :routing) do
  ...
  it 'routes /accounts/1/movements/1 to movements#update with put' do
  ...
  it 'routes /accounts/1/movements/1 to movements#update with patch' do
